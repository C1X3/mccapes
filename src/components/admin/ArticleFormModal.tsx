...
export default function ArticleFormModal({
    ...
    const [videoPreviewUrl, setVideoPreviewUrl] = useState<string>("");    const {
        control,
        handleSubmit,
        reset,
        setValue,
    ...
    const isLoading = createArticle.isPending || updateArticle.isPending || isUploading;    if (!isOpen) return null;
    ...
    return (
        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">                        {/* Title */}
                        <div>
                        ...
                        <div>
                            <label htmlFor="thumbnailUrl" className="block text-[var(--foreground)] mb-2">
                        ...
                        <div>
                            <label htmlFor="productSlug" className="block text-[var(--foreground)] mb-2">
                                Product Slug *
                            </label>
                            <Controller
                                name="productSlug"
                            ...
                            {/* Color */}
                            <div>
                                <label htmlFor="color" className="block text-[var(--foreground)] mb-2">
                                    Color
                                </label>
                                <Controller
                                    name="color"
                            ...
                            {/* Alignment */}
                            <div>
                                <label htmlFor="alignment" className="block text-[var(--foreground)] mb-2">
                                    Alignment
                                </label>
                                <Controller
                                    name="alignment"
                            ...
                            {/* Order */}
                            <div>
                                <label htmlFor="order" className="block text-[var(--foreground)] mb-2">
                                    Order
                                </label>
                                <Controller
                                    name="order"
