          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
              ...
              >
                ...
                >
                  MC Capes is the <span className="text-green-600 font-semibold">#1 online Minecraft cape shop</span>. We verify
                  that our cape codes are 100% legitimate before sending
                  them to our customers and strive to achieve customer
                  satisfaction. We attend the Minecraft Experience event
                  in person to get our cape codes and don&apos;t sell any
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-green-600 group-hover:text-green-500 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </motion.div>
                  <div>
                    <h3 className="font-bold text-xl text-gray-800 group-hover:text-green-600 transition-colors duration-300">Instant Delivery</h3>
                    <p className="text-gray-600 mt-1 group-hover:text-gray-800 transition-colors duration-300">All our cape codes are delivered instantly upon purchase. There is no need to wait for your code.</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-gray-800 group-hover:text-green-600 transition-colors duration-300">Secure Payments</h3>
                    <p className="text-gray-600 mt-1 group-hover:text-gray-800 transition-colors duration-300">All payments are made with card and securely processed through stripe to ensure that all data is safe.</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-gray-800 group-hover:text-green-600 transition-colors duration-300">24/7 Support</h3>
                    <p className="text-gray-600 mt-1 group-hover:text-gray-800 transition-colors duration-300">Join our discord server for 24/7 support from our dedicated staff if you have any issues with your order.</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-gray-800 group-hover:text-green-600 transition-colors duration-300">Rare Capes</h3>
                    <p className="text-gray-600 mt-1 group-hover:text-gray-800 transition-colors duration-300">We offer some of Minecraft&apos;s most difficult to find capes for an affordable price.</p>
                  </div>
                </motion.div>
              </div>
            </div>
