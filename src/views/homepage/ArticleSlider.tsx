...
const ArticleSlider = ({ articles, products }: ArticleSliderProps) => {
    ...
    const floatClass = currentArticle.alignment === "right" ? "float-right md:ml-6" : "float-left md:mr-6";
                        ...
                        >
                            ...
                            {currentArticle.productSlug && (
                                <motion.div
                                    ...
                                    variants={fadeInUp}
                                >
                                    <ProductCard product={products.find(x => x.slug === currentArticle.productSlug)!} styles="article" />
                                </motion.div>
                            )}
                            ...
                            <div className="mt-6 gap-4 flex justify-center">
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.97, transition: { duration: 0.1 } }}
                                    variants={fadeInUp}
                                    onClick={() => router.push(`/shop/${currentArticle.productSlug}`)}
                                >
                                    Purchase Now
                                </motion.button>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row h-full">
                            ...
                            <div className="md:w-1/2 p-6 flex items-center justify-center">
                                <div className="aspect-video w-full h-full max-h-[70vh] relative">
                                    {!isPlaying && thumbnailUrl ? (
                                        <div className="relative aspect-video w-full h-full cursor-pointer" onClick={handleVideoPlay}>
                                            <Image
                                                src={thumbnailUrl}
                                                alt={currentArticle.title}
                                                layout="fill"
