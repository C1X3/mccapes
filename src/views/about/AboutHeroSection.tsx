...
const features = [
  {
    ...
    description: "Cape codes delivered instantly upon purchase.",
  },
  {
    icon: (
    ...
    description: "Payments processed securely through Stripe.",
  },
  {
    icon: (
    ...
    title: "24/7 Support",
    description: "Dedicated staff available around the clock.",
  },
  {
    icon: (
